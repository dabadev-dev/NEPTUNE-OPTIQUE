        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-6">
            {orders.map((order) => (
              ...
              >
                {/* En-tête */}
                <div className="mb-6 flex flex-col justify-between gap-4 border-b pb-4 sm:flex-row">
                  <div>
                  ...
                  <select
                    ...
                    className="h-fit rounded border border-gray-300 bg-white px-4 py-2 text-sm"
                  >
                    {statuses.map((status) => (
                      <option
                        key={status}
